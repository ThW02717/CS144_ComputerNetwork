...
private:
  ...
  uint64_t next_byte_index() const { return writer().bytes_pushed(); };  // index of next byte to be written to ByteStream// How many bytes can be buffered in the Reassembler/ByteStream?
